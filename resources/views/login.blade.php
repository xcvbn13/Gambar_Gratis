    ...
    <div class="container mx-auto">
        <div class="flex justify-center px-6 my-12">
            ...
            <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                <!-- Col -->
                <div
                    class="w-full h-auto bg-gray-400 bg-contain hidden lg:block lg:w-1/2 bg-cover rounded-l-lg"
                    style="background-image: url('/img/login_img.jpg');"
                ></div>
                <!-- Col -->
                <div class="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
                    ...
                    <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-4" x-data="{ show: true }">
                            ...
                            <div class="inline-flex relative w-full items-center">
                                <input
                                    class="w-full block rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                    id="password"
                                    name="password"
                                ...
                                />
                                <div class="absolute block right-0 text-sm leading-3">
                                    <div class="px-3">
